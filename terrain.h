...
constexpr BLOCK BLOCK_REDSTONE_LAMP = 136; //Data: On/Off
constexpr BLOCK BLOCK_REDSTONE_SWITCH = 137; //Data: BLOCK_SIDE
constexpr BLOCK BLOCK_REDSTONE_WIRE = 138; //Data: (active: 1<<6, visited: 1<<5)
