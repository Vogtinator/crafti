...
OBJS = $(patsubst ./%.c, ./$(BUILDPATH)/%.o, $(shell find . -name \*.c -not -path './.github/*'))
OBJS += $(patsubst ./%.cpp, ./$(BUILDPATH)/%.o, $(shell find . -name \*.cpp -not -path './.github/*'))
OBJS += $(patsubst ./%.S, ./$(BUILDPATH)/%.o, $(shell find . -name \*.S -not -path './.github/*'))
